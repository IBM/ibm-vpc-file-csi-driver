...
[![IBM VPC File CSI Driver](https://github.com/IBM/ibm-vpc-file-csi-driver/actions/workflows/pipeline.yaml/badge.svg)](https://github.com/IBM/ibm-vpc-file-csi-driver/actions/workflows/pipeline.yaml)
...
3. The driver automatically:
   - Calls the node-local tunnel-manager service
...
- `STUNNEL_CA_FILE`: CA bundle path used by Stunnel
- `STUNNEL_NFS_PORT`: Remote RFS NFS port (default: 20049)
