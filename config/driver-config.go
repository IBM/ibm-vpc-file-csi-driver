...
const (
	...
	CSIDriverName = "vpc.file.csi.ibm.io"

	// CSISocketName ...
	CSISocketName = "unix:/tmp/csi-vpc-file.sock"

	// CSIDriverLogName ...
	CSIDriverLogName = "IBM VPC file driver"

	// CSIDriverGithubName ...
	CSIDriverGithubName = "ibm-vpc-file-csi-driver"
