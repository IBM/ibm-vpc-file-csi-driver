...
require (
	...
	github.com/IBM/ibmcloud-volume-file-vpc v1.0.0-beta5.0.20230130063957-274db9794917
	github.com/IBM/ibmcloud-volume-interface v1.0.1-beta8.0.20230202114358-7d4cf4c631cc
