...
require (
	github.com/IBM/ibm-csi-common v1.0.0-beta9.0.20220720064555-63fc342933b1
	github.com/IBM/ibmcloud-volume-file-vpc v1.0.0-beta3.0.20220808124007-a8aaaae396bf
