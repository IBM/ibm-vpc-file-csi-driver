...
require (
	github.com/IBM/ibm-csi-common v1.0.0-beta9.0.20220120112721-3a790c87ff75
	github.com/IBM/ibmcloud-volume-file-vpc v1.0.0-beta3
...
require (
	...
	github.com/IBM/ibmcloud-volume-vpc v1.0.0-beta15 // indirect
