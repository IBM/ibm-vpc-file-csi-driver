...
var (
	...
	stdENITopology = []*csi.Topology{
		{
			Segments: map[string]string{utils.NodeRegionLabel: "testregion"},
		},
	}
)
	...
	}{
		{
			...
			expResponse: &csi.ControllerGetCapabilitiesResponse{
				Capabilities: []*csi.ControllerServiceCapability{
					...
					// csi.ControllerServiceCapability_RPC_MODIFY_VOLUME omitted — not advertised until csi-test sanity suite is upgraded to v5+
