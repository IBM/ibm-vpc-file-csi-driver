...
// NOTE: This file exists as a non-test file because it's used by other packages' tests (pkg/ibmcsidriver/node_test.go)
// and Go doesn't allow cross-package access to functions in _test.go files.
